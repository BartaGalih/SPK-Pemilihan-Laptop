...
|----|-------------|-----------:|----:|----------:|------:|--------:|--------:|
| 1 | Acer Aspire 5 A514-56 | 9.499.000 | 16 GB | 15.000 | 1,45 kg | 512 GB | 8 jam |
...
| 2 | Klik **Tambah Laptop**, isi data laptop No.1, klik **Simpan** | Data laptop No.1 | Notifikasi "Data laptop berhasil ditambahkan", data muncul di daftar |
| 3 | Ulangi langkah 2 untuk laptop No.2 s/d No.5 | Data laptop No.2–5 | Total 5 laptop tampil di daftar Data Laptop |
| 4 | Buka menu **Kriteria & Bobot** | – | Tampil 6 kriteria, indikator **Total bobot = 1.00** berwarna hijau |
| 5 | Buka menu **Hasil Rekomendasi** | – | Tampil pesan "Belum ada hasil perhitungan" |
...
| 8 | (Opsional) Uji validasi: tambah laptop dengan Harga `500000` | price = 500000 | Ditolak — pesan "minimal 1.000.000" (harga di bawah batas) |
...
|:----:|-------------|----:|------------|
| 🥇 1 | **Acer Aspire 5 A514-56** | **3,6500** | Rekomendasi terbaik |
| 🥈 2 | ASUS Zenbook 14 OLED UX3405MA | 3,5500 | Runner-up |
| 🥉 3 | Dell Inspiron 14 5440 | 3,3000 | Pilihan ke-3 |
| 4 | Lenovo LOQ 15IRX9 | 3,1000 | – |
| 5 | HP Pavilion 14-dv2 | 2,4000 | – |

### Matriks Evaluasi Lengkap (NEF / NBE per kriteria)

**Peringkat 1 — Acer Aspire 5 A514-56 (TBE = 3,6500)**

| | C1 Harga | C2 RAM | C3 CPU | C4 Bobot | C5 Storage | C6 Baterai |
|---|---:|---:|---:|---:|---:|---:|
| NEF | 5,00 | 5,00 | 2,00 | 3,00 | 1,00 | 3,00 |
| NBE | 1,5000 | 1,0000 | 0,5000 | 0,3000 | 0,0500 | 0,3000 |

**Peringkat 2 — ASUS Zenbook 14 OLED UX3405MA (TBE = 3,5500)**

| | C1 Harga | C2 RAM | C3 CPU | C4 Bobot | C5 Storage | C6 Baterai |
|---|---:|---:|---:|---:|---:|---:|
| NEF | 1,00 | 5,00 | 4,00 | 5,00 | 5,00 | 5,00 |
| NBE | 0,3000 | 1,0000 | 1,0000 | 0,5000 | 0,2500 | 0,5000 |

**Peringkat 3 — Dell Inspiron 14 5440 (TBE = 3,3000)**

| | C1 Harga | C2 RAM | C3 CPU | C4 Bobot | C5 Storage | C6 Baterai |
|---|---:|---:|---:|---:|---:|---:|
| NEF | 3,00 | 5,00 | 3,00 | 2,00 | 1,00 | 4,00 |
| NBE | 0,9000 | 1,0000 | 0,7500 | 0,2000 | 0,0500 | 0,4000 |

**Peringkat 4 — Lenovo LOQ 15IRX9 (TBE = 3,1000)**

| | C1 Harga | C2 RAM | C3 CPU | C4 Bobot | C5 Storage | C6 Baterai |
|---|---:|---:|---:|---:|---:|---:|
| NEF | 2,00 | 5,00 | 5,00 | 1,00 | 1,00 | 1,00 |
| NBE | 0,6000 | 1,0000 | 1,2500 | 0,1000 | 0,0500 | 0,1000 |

**Peringkat 5 — HP Pavilion 14-dv2 (TBE = 2,4000)**

| | C1 Harga | C2 RAM | C3 CPU | C4 Bobot | C5 Storage | C6 Baterai |
|---|---:|---:|---:|---:|---:|---:|
| NEF | 4,00 | 1,00 | 1,00 | 4,00 | 1,00 | 3,00 |
| NBE | 1,2000 | 0,2000 | 0,2500 | 0,4000 | 0,0500 | 0,3000 |

> Catatan: HP Pavilion memiliki RAM 8 GB (terendah), sehingga NEF pada C2 (RAM) = 1,00; empat laptop lainnya ber-RAM 16 GB sehingga NEF C2 = 5,00.

---

## 7. Kesimpulan Demo

Hasil perhitungan menunjukkan **Acer Aspire 5 A514-56** sebagai **rekomendasi terbaik** dengan TBE tertinggi (3,6500). Meskipun performa CPU-nya tidak paling tinggi, laptop ini unggul pada kriteria berbobot besar yaitu **harga termurah (C1, bobot 0,30)** sehingga skor totalnya mengungguli laptop lain. Aplikasi dinyatakan **berjalan sesuai harapan** apabila urutan peringkat yang muncul sama dengan Tabel Hasil pada bagian 6.
...
| Validasi form (harga minimal) | ☐ Berhasil / ☐ Gagal |
| Total bobot kriteria = 1,00 | ☐ Berhasil / ☐ Gagal |
